...
commands_exist check_esensor_temp_txt check_esensor_humidity_txt check_esensor_light_txt check_em08_temp check_em08_humidity check_em08_light check_em08_rtd check_em08_voltage check_em08_contacts
